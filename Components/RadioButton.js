function RadioButton({value , ChangeStatus , checked }) {
    return (
        <div className="flex items-center pl-3">
            <input id={value} checked={checked} onChange={ChangeStatus} type="radio" value={value} name="list-radio" 
            ...
            <label htmlFor={value} className="w-full py-3 ml-2 text-sm font-medium text-white">{value}</label>
        </div>
    );
  }
